                    ...
                    <div class="col-md-6 col-sm-6"> 
						<div class="social-icons">
							<ul>
								...
								<li class="weblizar_social_media_linkedin_link"><a href="<?php echo esc_url($wl_theme_options['social_media_linkedin_link']); ?>" title="linkedin" target="_blank" class="social-media-icon linkedin-icon"><?php _e('Linkedin','weblizar'); ?></a></li>
								<?php } ?>
							</ul>
						</div>
                    </div>
