...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $cpb_support_forum = __("Ask For Help", "captcha-bank");

      //footer
      $cpb_upgrade = __("Premium Editions", "captcha-bank");
      ...
      $cpb_block_own_ip_address = __("You cannot block your own IP Address!", "captcha-bank");
      $cpb_block_own_ip_range = __("You cannot block this IP Range as your IP Address lies between this Range!", "captcha-bank");
