                     ...
                     <div class="form-body">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="ux_txt_address" id="ux_txt_address" value="<?php echo isset($_REQUEST["ip_address"]) ? long2ip_captcha_bank($_REQUEST["ip_address"]) : "" ?>" placeholder="<?php echo $cpb_valid_ip_address; ?>" onblur="check_ip_address_captcha_bank();" onfocus="prevent_paste_captcha_bank(this.id);" onkeypress="valid_ip_address_captcha_bank(event);">
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                        ...
                        <div class="form-actions">
                           <div class="pull-right">
                              <input type="button" class="btn vivid-green" name="ux_btn_clear" id="ux_btn_clear" value="<?php echo $cpb_button_clear; ?>" onclick="clear_value_ip_address_captcha_bank();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="ux_txt_cpb_start_date" value="<?php echo date("m/d/Y", esc_html($start_date)) ?>" id="ux_txt_cpb_start_date" onkeypress="prevent_data_captcha_bank(event)" placeholder="<?php echo $cpb_start_date_placeholder; ?>">
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="ux_txt_cpb_end_date" value="<?php echo date("m/d/Y", esc_html($timestamp)) ?>" id="ux_txt_cpb_end_date" onkeypress="prevent_data_captcha_bank(event);" placeholder="<?php echo $cpb_end_date_placeholder; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="form-actions">
                              ...
                              foreach ($manage_ip_address_date as $row) {
                                 ...
                                 <tr>
                                    <td style="text-align: center;">
                                       <input type="checkbox" onclick="check_all_captcha_bank('#ux_chk_all_manage_ip_address');" name="ux_chk_manage_ip_address_<?php echo intval($row["meta_id"]); ?>" id="ux_chk_manage_ip_address_<?php echo intval($row["meta_id"]); ?>" value="<?php echo $row["meta_id"]; ?>">
                                    </td>
                                    <td>
                                       <label>
                                          <?php echo long2ip_captcha_bank($row["ip_address"]); ?>
                                       </label>
                                    </td>
                                    <td>
                                       <label>
                                    ...
                                    <td class="custom-alternative" style="text-align:center;vertical-align:middle;width:10%;">
                                       <a href="javascript:void(0);">
                                          <i class="icon-custom-trash tooltips" data-original-title="<?php echo $cpb_delete; ?>" onclick="delete_ip_address_captcha_bank(<?php echo intval($row["meta_id"]); ?>)" data-placement="right"></i>
                                       </a>
                                    </td>
                                 </tr>
                                 <?php
